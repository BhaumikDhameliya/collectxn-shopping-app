  ...
  return (
    <div>
      <div className="relative">
        ...
        <div className="flex gap-3 absolute right-4 bottom-4">
        ...
        <div className="absolute opacity-20 left-4 bottom-4">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-6 ont-cera-pro">
            <p className="f">
              ...
              This is one of the lightest Air Jordan game shoes to date, with a
              minimal but durable leno-weave upper reinforced with tough plastic
              details. Meanwhile, Zoom Air cushioning delivers energy return and
              elite responsiveness. The game asks for everything—now you have
              the shoe to match.
            </p>
            <div>
              ...
              <ul className="list-disc pl-6">
                <li>
                  See-through leno-weave upper is strong and ultra-lightweight.
                </li>
                <li>
                  Wraparound ribbon of plastic helps to reinforce the materials.
                </li>
